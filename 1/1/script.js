var message_with_underscore, messageCammelCase; // Zmiennej nie musimy od razu przypisywać wartości, możemy to zrobić później.
var STALA_WARTOSC;
...
if (myFloat > myNumber) {
	outputVariable = 'Zmiennoprzecinkowa większa';
}
else {
	outputVariable = 'Całkowita większa';
}
 ...
 */
function doSomethingWithMyArray(currentElement, currentIndex, currentArray) {
	alert(currentElement);
	alert(currentIndex);
	alert(currentArray);
}

myArray.forEach(doSomethingWithMyArray);
